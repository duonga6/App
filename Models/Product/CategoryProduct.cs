...
namespace App.Models.Product
{
    public class CategoryProduct
    {
        ...
        public void ChildCategoriesID(ICollection<CategoryProduct> childcates, List<int> lists)
        {
            if (childcates == null) childcates = this.CategoryChildren;
            foreach(CategoryProduct cate in childcates)
            {
                lists.Add(cate.Id);
        ...
        public List<CategoryProduct> GetParentCategory()
        {
